export default function PaeWrapper(props) {
    return ( 
              ...
              <div className="col-md-4 col-sm-12 col-xs-12">
                <div className="sidebar">
                  ...
                  <div className="sb-facebook sb-it">
                    ...
                    <iframe
                      src="#"
                      data-src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ftemplatespoint.net%2F%3Ffref%3Dts&tabs=timeline&width=340&heigh"                    />                  </div>
            ...
            <div className="flex-parent-ft">
              ...
              <div className="flex-child-ft item5">
                ...
                <a href="#" className="btn">
                  Subscribe now <i 
                className="ion-ios-arrow-forward"></i>
                </a>
              </div>
            </div>
          </div>
